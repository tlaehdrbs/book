...
@RequiredArgsConstructor // final이 선언된 모든 필드를 인자로 하는 생성자를 롬복이 처리
@Service
public class PostsService {
    ...
    public void delete(Long id) {
        Posts posts = postsRepository.findById(id).orElseThrow(
                () -> new IllegalArgumentException("not exist this post! id: " + id));
